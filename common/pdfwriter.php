<?php
	require_once(in_parent_path('common/fpdf.php'));
//	require_once('fpdf.php');
// A compendium of public extensions to FPDF that do nice things
//		1. Extended Cell functions
//			Author: Pivkin Vladimir
//			License: Freeware
//		2. Text rotations
//			Informations
//			Author: Pivkin Vladimir
// Thanks repect and acknowledgement to all concerned

class PDFWriter extends FPDF
{
	function PDFWriter($or, $un, $f)
	{
		$this->FPDF($or, $un, $f);
	}
